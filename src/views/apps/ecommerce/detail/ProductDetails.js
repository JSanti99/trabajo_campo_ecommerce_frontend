  ...
  return (
    <Row className="my-2">
      ...
      <Col md="7" xs="12">
        ...
        <CardText>
          Disponible -<span className="text-success ml-25">En Stock</span>
        </CardText>
        <CardText>{<MarkdownPreview value={data.description} />}</CardText>
        ...
        <div className="d-flex flex-column flex-sm-row pt-1">
          ...
          >
            ...
            {data.isInCart ? "View in cart" : "Mover al carrito"}
          </Button>
          {/* <Button
