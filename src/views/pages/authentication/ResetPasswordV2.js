  ...
  <Fragment>
    ...
    <div className="toastify-body">
      <span role="img" aria-label="toast-text">
        {status == "success"
          ? "👋 Tú contraseña ha sido cambiada."
          : "Ocurrió un error al momento de intentar resetear la contraseña."}
      </span>
    </div>
  </Fragment>
);
...
const ResetPasswordV2 = (props) => {
  ...
  const [passwordConfirmation, setPasswordConfirmation] = useState("Admin1234");
